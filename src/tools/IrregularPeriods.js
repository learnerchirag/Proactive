    ...
    return (
      <>
        ...
        {this.state.dataArray === null ? (
          ...
          <div>
            <Header />
            <Container fluid className="pt-5 p-md-3 pt-md-5 mt-5">
              <div className="bc-tiles-wrapper mb-4">
                <div className="bc-tiles-intro-text w-md-75 mx-auto">
                  <h1
                  ...
                  <div className="d-block para-all">
                    <p>
                      Studies show that at least 14% of all women struggle with
                      some degree of irregularity in their periods. Irregular
                      periods may be indicative of underlying conditions such as
                      PCOS, thyroid, excess prolactin, inflamed pelvic region,
                      or ovary dysfunction.
                    </p>
                    <p>
                      <strong>
              ...
              {this.state.button === 1 && (
                <div>
                  <Card className="text-center mt-3 p-md-4 p-0 shadow border-0">
                    <div className="px-md-5 px-3" style={{}}>
                      <h5 style={{ color: "#163948", fontWeight: "bold" }}>
                        The number of days between your period, duration of
                        bleeding, and persistence of irregularity, are key
                        factors that help a physician get to the root of your
                        concerns.
                        <br></br>
                        <br></br>
                  ...
                  <Row className="p-3 questions">
                    <Col md="4" className="">
                      ...
                      >
                        <h6 className="sub-header-all">
                          How would you categorize the nature of your
                          irregularity? (Select all that apply)
                        </h6>
                        <Card
                          id={"1"}
                    ...
                    <Col md="4" className="mt-2 mt-md-0">
                      ...
                      >
                        <h6 className="sub-header-all">
                          How long have you observed irregularity in your
                          periods?
                        </h6>
                        <Card
                          id={"a"}
                        ...
                        <div className="m-5">
                          <div className="d-flex">
                            <FontAwesomeIcon
                              className="mt-1"
                              style={{
                                display: this.state.q1 ? "block" : "none",
                              }}
                            ...
                            <div>
                              ...
                              <p className="my-auto pl-2">
                                {this.state.q1 === "1"
                                  ? "The absense of menstrual periods is referred to as Amenorrhea, and is known to occur during pregnancy and menopause."
                                  : this.state.q1 === "2"
                                  ? "Infrequent menstrual periods that have cycles greater than 35 days is referred to as oligomenorrhea."
                                  : this.state.q1 === "3"
                                  ? "Infrequent menstrual periods that have cycles shorter than 21 days is referred to as polymenorrhea."
                                  : null}
                              </p>
                            </div>
                          </div>
                          <div className="d-flex">
                            ...
                            <div>
                              ...
                              <p className="my-auto pl-2">
                                {this.state.q1_1 === "4"
                                  ? "Heavy prolonged bleeding for greater than 7 days is referred to as menorrhagia."
                                  : this.state.q1_1 === "5"
                                  ? "Very light or scanty bleeding is referred to as hypomenorrhea."
                                  : null}
                              </p>
                            </div>
                          </div>
                          <div className="d-flex">
                            <FontAwesomeIcon
                              className="mt-1"
                              style={{
                                display: this.state.q2 ? "block" : "none",
                              }}
                              icon={faAngleDoubleRight}
                            />
                            <h5 className="my-auto pl-2">
              ...
              {this.state.button === 2 && (
                <div>
                  <Card className="text-center mt-3 p-md-4 p-0 shadow border-0">
                    <div className="px-md-5 px-3" style={{}}>
                      <h5 style={{ color: "#163948", fontWeight: "bold" }}>
                        Irregular periods could be due to any number of
                        underlying causes. Often, the symptoms you experience
                        can go a long way in identifying the underlying cause of
                  ...
                  <Row>
                    <Col className="text-center order-md-1 order-2">
                      <div className="mt-3 ">
                        <Tooltip
                    ...
                    <Col className="pt-3 symptoms order-md-2" md="6">
                      <h6>Tell us your symptoms</h6>
                      <small style={{ color: "#163948" }}>
                        Select your symptoms from the body model or use the
                  ...
                  <Row className="p-3">
                    <Col>
                      ...
                      >
                              ...
                              {this.state.activeCauses.length === 0
                                ...
                                : "You could be suffering from" +
                                  this.state.activeCauses.map((val, i) => {
                                    if (
                                      i ===
                                      this.state.activeCauses.length - 1
                                    ) {
                                      return " " + causes[val] + ".";
                        ...
                        <Row>
                          <Col md="6" lg="3" className="text-center my-3">
                            <Card
                            ...
                            >
                              ...
                              {!this.handleCauses(
                                ...
                                <div className="">
                                  <small>
                                    {
                                      this.state.dataArray.Endometriosis
                                        .Main_Text
                                    }
                                  </small>
                                </div>
                            ...
                            >
                              ...
                              {!this.handleCauses(
                                ...
                                <div className="">
                                  <small>
                                    {
                                      this.state.dataArray.Thyroidism_hypo
                                        .Main_Text
                                    }
                                  </small>
                                </div>
                          ...
                          <Col md="6" lg="3" className="text-center my-3">
                            ...
                            >
                              ...
                              {this.state.activeFilters.includes("a") && (
                                <div>
                                  <small>
                                    {this.state.dataArray.Thy_hyper.a}
                                  </small>
                                </div>
                              )}
                              {this.state.activeFilters.includes("b1") && (
                                <div>
                                  <small>
                                    {this.state.dataArray.Thy_hyper.b1}
                                  </small>
                                </div>
                              )}
                              {this.state.activeFilters.includes("b2") && (
                                <div>
                                  <small>
                                    {this.state.dataArray.Thy_hyper.b2}
                                  </small>
                                </div>
                              )}{" "}
                              {this.state.activeFilters.includes("b3") && (
                                <div>
                                  <small>
                                    {this.state.dataArray.Thy_hyper.b3}
                                  </small>
                                </div>
                              )}
                              {this.state.activeFilters.includes("c") && (
                                <div>
                                  <small>
                                    {this.state.dataArray.Thy_hyper.c}
                                  </small>
                                </div>
                              )}
                              {this.state.activeFilters.includes("d") && (
                                <div>
                                  <small>
                                    {this.state.dataArray.Thy_hyper.d}
                                  </small>
                                </div>
                              )}
                              {this.state.activeFilters.includes("e") && (
                                <div>
                                  <small>
                                    {this.state.dataArray.Thy_hyper.e}
                                  </small>
                                </div>
                              )}
                              {this.state.activeFilters.includes("f") && (
                                <div>
                                  <small>
                                    {this.state.dataArray.Thy_hyper.f}
                                  </small>
                                </div>
                              )}
                              {this.state.activeFilters.includes("g") && (
                                <div>
                                  <small>
                                    {this.state.dataArray.Thy_hyper.g}
                                  </small>
                                </div>
                              )}
                              {this.state.activeFilters.includes("h1") && (
                                <div>
                                  <small>
                                    {this.state.dataArray.Thy_hyper.h1}
                                  </small>
                                </div>
                              )}
                              {this.state.activeFilters.includes("h2") && (
                                <div>
                                  <small>
                                    {this.state.dataArray.Thy_hyper.h2}
                                  </small>
                                </div>
                              )}
                              {this.state.activeFilters.includes("i") && (
                                <div>
                                  <small>
                                    {this.state.dataArray.Thy_hyper.i}
                                  </small>
                                </div>
                              )}
                              {this.state.activeFilters.includes("j") && (
                                <div>
                                  <small>
                                    {this.state.dataArray.Thy_hyper.j}
                                  </small>
                                </div>
                              )}
                              {this.state.activeFilters.includes("k") && (
                                <div>
                                  <small>
                                    {this.state.dataArray.Thy_hyper.k}
                                  </small>
                                </div>
                              )}
                              {this.state.activeFilters.includes("l") && (
                                <div>
                                  <small>
                                    {this.state.dataArray.Thy_hyper.l}
                                  </small>
                                </div>
                              )}
                              {this.state.activeFilters.includes("m") && (
                                <div>
                                  <small>
                                    {this.state.dataArray.Thy_hyper.m}
                                  </small>
                                </div>
                              )}
                              {this.state.activeFilters.includes("n1") && (
                                <div>
                                  <small>
                                    {this.state.dataArray.Thy_hyper.n1}
                                  </small>
                                </div>
                              )}
                              {this.state.activeFilters.includes("n2") && (
                                <div>
                                  <small>
                                    {this.state.dataArray.Thy_hyper.n2}
                                  </small>
                                </div>
                              )}
                              {this.state.activeFilters.includes("o") && (
                                <div>
                                  <small>
                                    {this.state.dataArray.Thy_hyper.o}
                                  </small>
                                </div>
                              )}
                              {this.state.activeFilters.includes("p") && (
                                <div>
                                  <small>
                                    {this.state.dataArray.Thy_hyper.p}
                                  </small>
                                </div>
                              )}
                            </Card>
                          ...
                          <Col md="6" lg="4" className="text-center my-3">
                            ...
                            >
                              ...
                              {this.state.activeFilters.includes("b1") && (
                                <div>
                                  <small>
                                    {this.state.dataArray.Stress.b1}
                                  </small>
                                </div>
                              )}
                              {this.state.activeFilters.includes("b2") && (
                                <div>
                                  <small>
                                    {this.state.dataArray.Stress.b2}
                                  </small>
                                </div>
                              )}{" "}
                              {this.state.activeFilters.includes("b3") && (
                                <div>
                                  <small>
                                    {this.state.dataArray.Stress.b3}
                                  </small>
                                </div>
                              )}
                              {this.state.activeFilters.includes("c") && (
                              ...
                              {this.state.activeFilters.includes("h1") && (
                                <div>
                                  <small>
                                    {this.state.dataArray.Stress.h1}
                                  </small>
                                </div>
                              )}
                              {this.state.activeFilters.includes("h2") && (
                                <div>
                                  <small>
                                    {this.state.dataArray.Stress.h2}
                                  </small>
                                </div>
                              )}
                              {this.state.activeFilters.includes("i") && (
                              ...
                              {this.state.activeFilters.includes("n1") && (
                                <div>
                                  <small>
                                    {this.state.dataArray.Stress.n1}
                                  </small>
                                </div>
                              )}
                              {this.state.activeFilters.includes("n2") && (
                                <div>
                                  <small>
                                    {this.state.dataArray.Stress.n2}
                                  </small>
                                </div>
                              )}
                              {this.state.activeFilters.includes("o") && (
              ...
              <Share
                fbH={
                  "https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Fwww.proactiveforher.com%2Ftools%2Firregular-periods%2F"
                }
                twH={
                  "https://twitter.com/share/?text=Explore%20your%20symptoms.%20Understand%20your%20period%20better.&amp;url=http%3A%2F%2Fproactiveforher.com%2Ftools%2Firregular-periods%2F"
                }
                emH={
                  "mailto:?subject=Explore%20your%20symptoms.%20Understand%20your%20period%20better.&amp;body=http%3A%2F%2Fproactiveforher.com%2Ftools%2Firregular-periods%2F"
                }
                liH={
                  "https://www.linkedin.com/shareArticle?mini=true&amp;url=http%3A%2F%2Fproactiveforher.com%2Ftools%2Firregular-periods%2F&amp;title=Explore%20your%20symptoms.%20Understand%20your%20period%20better.&amp;source=http%3A%2F%2Fproactiveforher.com%2Ftools%2Firregular-periods%2F"
                }
                whH={
                  "https://api.whatsapp.com/send?text=Explore%20your%20symptoms.%20Understand%20your%20period%20better%20http%3A%2F%2Fproactiveforher.com%2Ftools%2Firregular-periods%2F"
                }
              />
            </Container>
            <FooterMain />
